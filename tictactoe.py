...
def game_opening():
    ...
    pg.draw.line(screen, line_color, (width / 3, 0), (width / 3,
                 height), 7)
    pg.draw.line(screen, line_color, (width / 3 * 2, 0), (width / 3
                 * 2, height), 7)
...
def check_win():
    ...
    for row in range(0, 3):
        if TTT[row][0] == TTT[row][1] == TTT[row][2] and TTT[row][0] \
            ...
            winner = TTT[row][0]
            # draw winning line
            pg.draw.line(screen, (250, 0, 0), (0, (row + 1) * height
                         / 3 - height / 6), (width, (row + 1) * height
                         / 3 - height / 6), 4)
            break
...
def isWinner(bo, le):
    ...
    return bo[7] == le and bo[8] == le and bo[9] == le or bo[4] == le \
        and bo[5] == le and bo[6] == le or bo[1] == le and bo[2] == le \
        and bo[3] == le or bo[1] == le and bo[4] == le and bo[7] == le \
        or bo[2] == le and bo[5] == le and bo[8] == le or bo[3] == le \
        and bo[6] == le and bo[9] == le or bo[1] == le and bo[5] == le \
        and bo[9] == le or bo[3] == le and bo[5] == le and bo[7] == le
